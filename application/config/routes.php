...
$route['dfs'] = 'Website/ThuatToan/dfsIndex';
$route['dfs/test'] = 'Website/ThuatToan/dfsTest';

$route['hoan-vi'] = 'Website/ThuatToan/hoanViIndex';
$route['hoan-vi/test'] = 'Website/ThuatToan/hoanViTest';
